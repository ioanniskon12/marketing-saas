...
export function digestEmail({
  ...
  const content = `
        ...
        ${topPosts.map((post, index) => `
          <div style="background-color: #f9fafb; padding: 16px; border-radius: 8px; margin-bottom: 16px;">
            <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 8px;">
              ...
              <div style="background-color: #ffffff; padding: 8px 12px; border-radius: 6px; font-weight: 600; color: #ff8c42;">
    ...
    <p class="text-muted">
      ...
      <a href="{{APP_URL}}/settings/notifications" style="color: #ff8c42; text-decoration: none;">Manage email preferences</a>
    </p>
  `;
