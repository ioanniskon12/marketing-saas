          ...
          <tr>
            <td class="email-footer">
              ...
              <p style="margin: 0 0 16px 0;">
                <a href="{{APP_URL}}/dashboard" style="color: #ff8c42; text-decoration: none;">Dashboard</a> •
                <a href="{{APP_URL}}/settings/notifications" style="color: #ff8c42; text-decoration: none;">Email Preferences</a> •
                <a href="{{APP_URL}}/support" style="color: #ff8c42; text-decoration: none;">Support</a>
              </p>
