  ...
  const content = `
    ...
    <div style="margin: 24px 0;">
      <div style="display: flex; align-items: start; margin-bottom: 20px;">
        <div style="flex-shrink: 0; width: 32px; height: 32px; background-color: #ff8c42; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; margin-right: 16px;">1</div>
        <div>
      ...
      <div style="display: flex; align-items: start; margin-bottom: 20px;">
        <div style="flex-shrink: 0; width: 32px; height: 32px; background-color: #ff8c42; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; margin-right: 16px;">2</div>
        <div>
      ...
      <div style="display: flex; align-items: start;">
        <div style="flex-shrink: 0; width: 32px; height: 32px; background-color: #ff8c42; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; margin-right: 16px;">3</div>
        <div>
    ...
    <p>
      We're here to help! Check out our <a href="{{APP_URL}}/docs" style="color: #ff8c42; text-decoration: none;">documentation</a>
      or reach out to our <a href="{{APP_URL}}/support" style="color: #ff8c42; text-decoration: none;">support team</a> if you have any questions.
    </p>
